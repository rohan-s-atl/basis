...
class Outcome(Base):
    ...
    return_bucket: Mapped[str] = mapped_column(String(16), nullable=False, default="flat")
    benchmark_return: Mapped[Optional[float]] = mapped_column(Float, nullable=True, default=None)
    excess_return: Mapped[Optional[float]] = mapped_column(Float, nullable=True, default=None)
    benchmark_label: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, default=None)
